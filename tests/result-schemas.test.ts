...
describe('result schemas', () => {
  it('parses a valid PR review payload', () => {
    const result = parsePRReviewResult(JSON.stringify({
      approved: true,
      score: 91,
      summary: 'ok',
      ruleViolations: [],
  ...
  it('rejects empty, non-object, and malformed PR review payloads', () => {
    ...
    expect(() => parsePRReviewResult(JSON.stringify({
      approved: 'yes',
      score: 1,
      summary: 'x',
      ruleViolations: [],
  ...
  it('parses a valid issue triage payload', () => {
    const result = parseIssueTriageResult(JSON.stringify({
      category: 'feature',
      complexity: 'high',
  ...
  it('rejects invalid issue triage payloads', () => {
    ...
    expect(() => parseIssueTriageResult(JSON.stringify({
      category: 'feature',
      complexity: 'extreme',
      recommendedLabels: [],
      hasReproductionSteps: false,
